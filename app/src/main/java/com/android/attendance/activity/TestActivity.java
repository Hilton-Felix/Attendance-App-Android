	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				attendanceSessionBean.setAttendance_session_department("APT");
				attendanceSessionBean.setAttendance_session_class("APT3060");
				attendanceSessionBean.setAttendance_session_date("06/04/2021");
